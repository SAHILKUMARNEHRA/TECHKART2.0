    ...
    <>
      <div className="grid gap-6 lg:grid-cols-[1fr_360px] lg:items-start">
        <div className="space-y-4">
          <div className="rounded-3xl border border-tk-border bg-white/70 p-5 shadow-soft backdrop-blur-sm">
          ...
          <div className="rounded-3xl border border-tk-border bg-white/70 p-5 shadow-soft backdrop-blur-sm">
            ...
            {!user ? (
              <div className="mt-4 rounded-2xl border border-tk-border bg-white/80 p-4 shadow-sm">
              ...
              <div className="mt-4 grid gap-3">
                {addresses.length ? (
                  <div className="grid gap-2">
                    {addresses.map((a) => (
                      <label
                        key={a.id}
                        className="flex cursor-pointer items-start gap-3 rounded-2xl border border-tk-border bg-white/80 p-4 shadow-sm transition hover:bg-white"
                      >
                        <input
                          type="radio"
                          name="address"
                  ...
                  <div className="rounded-2xl border border-tk-border bg-white/80 p-4 text-sm text-slate-700 shadow-sm">
                ...
                {selectedAddressId ? (
                  ...
                  <div className="rounded-2xl border border-tk-border bg-white/80 p-4 shadow-sm">
                    ...
                    <div className="mt-3 grid gap-2">
                      <div className="grid grid-cols-2 gap-2">
                        <input
                          ...
                          className="h-11 rounded-xl border border-tk-border bg-white/90 px-3 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-blue-300 focus:ring-4 focus:ring-blue-200/40"
                        />
                        <input
                          value={phone}
          ...
          <div className="rounded-3xl border border-tk-border bg-white/70 p-5 shadow-soft backdrop-blur-sm">
            ...
            <div className="mt-4 grid gap-2">
              <label className="flex cursor-pointer items-center justify-between gap-3 rounded-2xl border border-tk-border bg-white/80 p-4 shadow-sm transition hover:bg-white">
                <div>
        ...
        <div className="sticky top-20 space-y-4">
          <div className="rounded-3xl border border-tk-border bg-white/70 p-6 shadow-soft backdrop-blur-sm">
            <div className="font-display text-2xl font-bold text-slate-900">Order summary</div>
            <div className="mt-6 space-y-4 text-sm text-slate-700">
              ...
              <div className="flex items-center justify-between">
                <span>Delivery</span>
                <span className="font-bold">{delivery === 0 ? 'Free' : formatInr(delivery)}</span>
              </div>
              <div className="mt-4 border-t border-tk-border pt-4 flex items-center justify-between">
                <span className="font-bold text-slate-900">Total</span>
                <span className="font-display text-2xl font-bold text-slate-900">{formatInr(total)}</span>
              </div>
            </div>
      ...
      {success ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="relative w-full max-w-lg rounded-3xl border border-tk-border bg-white/95 p-6 shadow-lift backdrop-blur-xl">
