...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-40 border-b border-tk-border bg-white/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-6xl items-center gap-3 px-4">
          ...
          >
            ...
            <input
              ...
              className="h-11 w-full rounded-2xl border border-tk-border bg-white/90 pl-10 pr-10 text-sm text-slate-900 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-blue-300 focus:ring-4 focus:ring-blue-200/40"
            />
            {q.length > 0 ? (
              <button
                type="button"
          ...
          <div className="flex items-center gap-2">
            ...
            {user ? (
              <div className="relative">
                ...
                {isMenuOpen ? (
                  <div className="absolute right-0 top-14 z-50 w-56 overflow-hidden rounded-2xl border border-tk-border bg-white/95 shadow-lift backdrop-blur-xl">
